        ...
        <div class="tinySizeHandler">
            ...
            <header class="mainHeader header-responsive organizer mobileVersion">
                ...
                <div class="d-flex align-items-center">
                    <div class="innerNav bag rightNavigationMenu rightFloat open-modal cursor-pointer ml-1 d-none"
                         data-target=".panel-menu.bag">
                        <span class="icon icon-cart"></span>
                    </div>

                    <div class="innerNav rightNavigationMenu rightFloat open-modal cursor-pointer"
                         data-target=".panel-menu.dashbord">
                        ...
                        @if(!\Facades\App\Libraries\ProfileHelper::DoesUserSetRealName($profile->id))
                            <a href="{{ route('dashboard.my-profiles.edit', \Facades\App\Libraries\ProfileHelper::getCurrentProfile()->id) }}">
                                <div
                                    ...
                                    لطفا اطلاعات پروفایل خود را بروزرسانی نمایید.
                                </div>
                            </a>
                        @endif
                        <!--begin::content-->
            ...
            <div class="menuOpen panel-menu dashbord">
                <div class="menuClose mobileVersion hidden cursor-pointer close-modal"
                     data-target=".panel-menu.dashbord"></div>
                <div class="menuWhiteBox">
                    <div class="logoAndClose mobileVersion">
                        <div class="AzShanbehLogo">
                            از شنبه
                        </div>
                        <div class="icon icon-close cursor-pointer close-modal"
                             data-target=".panel-menu.dashbord"></div>
                    </div>
            ...
            <div class="menuOpen panel-menu d-none bag">
                <div class="menuClose mobileVersion hidden cursor-pointer close-modal"
                     data-target=".panel-menu.bag"></div>
                <div class="menuWhiteBox">
                    <div class="logoAndClose mobileVersion">
                        <div class="AzShanbehLogo">
                            از شنبه
            ...
            <div class="popUpWhiteBox relative edit-profile-form">
                ...
                <div class="popUpBoxHeader font-size-18 boldFont organizer">
                    ...
                    <div class="popUpBoxCross leftFloat">
                        <span class="pos-relative icon icon-close cursor-pointer close-modal"
