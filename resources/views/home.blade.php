...
@section('body')
    ...
    <!--end::Header-->
                    ...
                    <div class="alignItem d-flex flex-wrap">
                        <div class="rightContent order-2">
                            ...
                            <div class="titleDescription font-size-14 lightFont organizer font-size-16-desktop">
                                ازشنبه یه پلتفرم دریافت رژیم غذایی آنلاین هست اینجا همه چیزهایی که برای یک رژیم لاغری
                                موثر نیاز دارین در اختیارتون قرار داده میشه. دستورالعملی 21 روزه مطابق با سلیقه
                                غذایی شما رو به آرزوتون می رسونه. با ثبت نام توی سایت و وارد کردن اطلاعات فیزیکی بدن‌تون
                                میتونید برنامه
                                غذایی منحصر به فرد خودتون رو از متخصصین تغذیه ما دریافت کنید. از شنبه رژیمی را براتون
                                طراحی می کنه که با ذائقه غذایی
                                تون سازگار باشه!!
                            </div>
                        </div>
                        ...
                        <div class="signInBox pos-relative responsive-m-t order-1" id="SignInBox">
                            <div
                                class="show-register-box registerTitle font-size-18 title-auth-home signin-btn-home boldFont cursor-pointer">
                                ثبت نام
                            </div>

                            <div
                                class="font-size-14 lightFont startDiet sub-title-auth-home d-flex flex-wrap pos-relative">
                            ...
                            <!--
                            <form method="POST" class="register-form homePageRegister" action="https://azshanbe.me/setVerificationCode">
                                <input type="hidden" name="_token" value="7D9AHRLGIcMLGz65glvMcMmEXGAWkXb2sKSaY478">
                            ...
                            <div class="d-flex align-items-center justify-content-between box-btn-reg-header w-100">
                                <p class="w-100" style="text-align: justify;">
                                    با کمک رفتاردرمانی، تغی در سبک زندگی، افزایش فعالیت بدنی و مهم تر از همه اصلاح رژیم
                                    غذایی به افراد کمک می &zwnj;کنه تغییر وزن تضمینی داشته باشن. تاکید در رژیم درمانی
                                    روی ازبین بردن عادات غذایی نادرست در افراده.<br>آماده&zwnj;ای برای دریافت رژیم؟
                                </p>
                            </div>
                            @if(!\Illuminate\Support\Facades\Auth::check())
                                <a style="display: block" class="w-100" href="{{ route('verification-code-login') }}">
                                    <button
                                        class="submit-button redBackColor whiteColor organizer register register-btn cursor-pointer">
                                    <span class="submit-button-title rightFloat font-size-14 boldFont"
                                          data-title="شروع ثبت نام">شروع ثبت نام</span>
                                        <span class="icon icon-forward font-size-18 leftFloat"></span>
                                    </button>
                                </a>
                            @else
                                <a style="display: block" class="w-100" href="{{ route('dashboard.home') }}">
                                    <button
                                        class="submit-button greenBackColor whiteColor organizer register register-btn cursor-pointer">
                                    <span class="submit-button-title rightFloat font-size-14 boldFont"
                                          data-title="شروع ثبت نام">ورود به پنل</span>
                                        {{--                                    <span class="icon icon-forward font-size-18 leftFloat"></span>--}}
                                        <span class="menuItemIcon icon icon-dash font-size-18 leftFloat"></span>
                                    </button>
                                </a>
                            @endif


                            <form method="POST" class="set-verification-code d-none"
                                  action="https://azshanbe.me/setVerificationCode">
                                <input type="hidden" name="_token" value="7D9AHRLGIcMLGz65glvMcMmEXGAWkXb2sKSaY478">
                                <div class="valuableInput relative organizer box-input">
                                    <div class="valuableInput relative organizer box-tel-input">
                                        <input type="tel" placeholder="شماره همراه"
                                               class="mobile_number input numberInput azshanbeInput custom-color-gray "
                                               name="mobile_number" value="" required="" autocomplete="mobile_number"
                                               autofocus="">
                                        <span class="valueInInput">
                                        <span class="separator"></span>
                                        +۹۸
                                ...
                                <button type="submit"
                                        class="submit-button greenBackColor whiteColor organizer register register-btn cursor-pointer">
                                    <span class="submit-button-title rightFloat font-size-14 boldFont"
                                          data-title="ورود">ورود</span>
                                    <span class="icon icon-forward font-size-18 leftFloat"></span>
                                </button>
                            </form>


                            <form method="POST" class="verification-code-login d-none"
                                  action="https://azshanbe.me/login">
                                <input type="hidden" name="_token" value="7D9AHRLGIcMLGz65glvMcMmEXGAWkXb2sKSaY478">
                                <div class="valuableInput relative organizer box-input">
                                    <div class="valuableInput relative organizer box-tel-input">
                                ...
                                <div class="valuableInput relative organizer box-input">
                                    <div class="valuableInput relative organizer box-tel-input">
                                        <input type="number" placeholder="کد تایید خود را وارد کنید"
                                               class="input numberInput azshanbeInput custom-color-gray "
                                               name="verification_code" autocomplete="off" autofocus="" required="">
                                    </div>
                                </div>

                                <div
                                    class="send-again d-none align-items-center flex-wrap justify-content-between d-flex w-100">
        ...
        <div class="whiteSpace organizer">
            ...
            <div class="organizer textInCenter position-relative my-8">
                    ...
                    <div class="swiper-container swiper-companions">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                ...
                                <p class="mx-20 my-8 p-companions">
                                    سحر با اینکه بیماری پلی کیستیک داشت و بخاطر مصرف داروهای هورمونی وزن کم نمی کرد طی
                                    دو دوره با رژیم های ازشنبه تونست ۶ کیلو کم کنه.
                                </p>
                            </div>
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                ...
                                <p class="mx-20 my-8 p-companions">
                                    رویا بخاطر اضافه وزن و خطر بارداری نیاز به 10 کیلو کاهش وزن داشت که با انگیزه بسیار
                                    بالا با رژیم همراهی داشت و الان به وزن مطلوب رسیده.
                                </p>
                            </div>
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                ...
                                <p class="mx-20 my-8 p-companions">
                                    سایه به خاطر رژیم های مختلفی که استفاده کرده بود دچار استپ وزنی شد و به کمک متخصصین
                                    ازشنبه تونست قفل این استپ رو بشکنه و از بهترین های ازشنبه باشه.
                                </p>
                            </div>
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                ...
                                <p class="mx-20 my-8 p-companions">
                                    مهتاب بخاطر سن کم با رژیم های خوب ازشنبه و انگیزه بالا تغییر حیرت انگیزی داشت و این
                                    تغییر بعد از چند ماه هنود بازگشت وزن نداره.
                                </p>
                            </div>
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                ...
                                <p class="mx-20 my-8 p-companions">
                                    شهلا بخاطر آرتروز شدید و تجویز بزشک چهارده کیلو تو سه دوره کم کرد و تیم پشتیبانی
                                    ازشنبه کنارشون بود.
                                </p>
                            </div>
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                ...
                                <p class="mx-20 my-8 p-companions">
                                    کمر درد زیاد و تنگی نفس علت کاهش وزن من بود و همیشه از این مشکل ناراحت بودم اما الان
                                    خوشحالم که به بهترین حالتم رسیدم و تغذیه مناسب بدنم رو پیدا کردم.
                ...
                <div class="companions-button-next arrow-companions companions"><img class=""
                                                                                     src="./img/right-arrow.svg"></div>
                <div class="companions-button-prev arrow-companions companions"><img class=""
                                                                                     src="./img/left-arrow.svg"></div>
            </div>
            ...
            <div class="organizer textInCenter position-relative my-8">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                <div class="content px-3 py-3 d-flex flex-wrap">
                                    ...
                                    <p class="p-companions">
                                        من با رژیم های از شنبه تونستم 5 کیلو تو یک دوره کم کنم و از 69 کیلو به 65 کیلو
                                        برسم و خیلی راضیم.
                                    </p>
                                </div>
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                <div class="content px-3 py-3 d-flex flex-wrap">
                                    ...
                                    <p class="p-companions">
                                        من از شنبه تشکر می کنم چون تونستم کاهش وزن خوبی داشته باشم و با اینکه بیمارب
                                        روده دارم 6 کیلو کم کردم
                                    </p>
                                </div>
                                <div class="audiobox w-100 d-flex">
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                <div class="content px-3 py-3 d-flex flex-wrap">
                                    ...
                                    <p class="p-companions">
                                        من با اینکه خیلی رعایت ندارم با این حال 2 کیلو وزن کم کردم خیلی خوشحالم و خواستم
                                        از شما و تیم خوبتون تشکر کنم.
                                    </p>
                                </div>
                                <div class="audiobox w-100 d-flex">
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                <div class="content px-3 py-3 d-flex flex-wrap">
                                    ...
                                    <p class="p-companions">
                                        من همیشه از جاهای مختلف رژیم گرفتم و و راضی نبودم اما ازرژیم شما خیلی راحت بودم
                                        و با اینکه ابتدای رژیم هستم تغییراتم محسوس است و وقت کم کردم
                                    </p>
                                </div>
                                <div class="audiobox w-100 d-flex">
                            ...
                            <div class="swiper-slide" style="width: 50% !important;height: auto;">
                                <div class="content px-3 py-3 d-flex flex-wrap">
                                    ...
                                    <p class="p-companions">
                                        فوق العاده از رژیم های از شنبه راضی هستم و با توجه به قیمت پایینش فکر نمی کردم
                                        انقدر خوب و تاثیرگار باشه .من با این رزیم چربی سوزی داشتم و در 14 روز اول 3 کیلو
                                        وزن کم کردم در حالی که اصلا گرسنگی حس نکردم..ممنونم از شما
                                    </p>
                                </div>
                                <div class="audiobox w-100 d-flex">
                ...
                <div class="companions-button-next arrow-companions audio"><img class="" src="./img/right-arrow.svg">
                </div>
                <div class="companions-button-prev arrow-companions audio"><img class="" src="./img/left-arrow.svg">
                </div>
            </div>
            ...
            <div class="instagramFollow textInCenter textInCenter d-flex flex-wrap position-relative w-100 mt-4">
                ...
                <span
                    class="instagramButton goto-video font-size-18 d-flex justify-content-center whiteColor cursor-pointer"
                    title="azshanbe.me">
        ...
        <!--end::contact-us-form-->
                ...
                <div class="mediumSizeHandler">
                    <div class="questionBox">
                        ...
                        <div class="answer lightFont organizer">
                            با کمک رفتاردرمانی، تغیر در سبک زندگی، افزایش فعالیت بدنی و مهم تر از همه اصلاح رژیم غذایی
                            به افراد کمک می ‌کنه تغییر وزن تضمینی داشته باشن. تاکید در رژیم درمانی روی ازبین بردن عادات
                            غذایی نادرست در افراده.
                        </div>
                    </div>
                    <div class="questionBox">
                        <div class="question boldFont">
                        ...
                        <div class="answer lightFont organizer">
                            رژیم هایی که به شما وعده لاغری سریع میدن فاقد اعتبارن، چون آسیب های زیادی به دنبال دارن. در
                            رژیمی که با رعایت اصول علمی طراحی شده هدف از کاهش وزن کاهش چربی بدنه و نه از بین بردن آب یا
                            بافت عضلانی. متخصصان از شنبه با توجه به اصول علمی و با دقت زیاد رژیم شما رو طراحی میکنن.
                        </div>
                    </div>
                    <div class="questionBox">
                        <div class="question boldFont">
                        ...
                        <div class="answer lightFont organizer">
                            تمام وعده ها و میان وعده های غذایی در رژیم های از شنبه به تفکیک مشخص شده. جایگزین ها هم برای
                            هر وعده در نظر گرفته شده که در صورت در دسترس نبودن یک ماده غذایی یا عدم تمایل شما به اون
                            وعده غذایی بتونید به راحتی جایگزینش کنید. در انتخاب میوه ها دست شما بازه بر اساس جدولی که تو
                            رژیم تون ارائه شده، میوه های مختلف رو جایگزین کنین. به بخش «پیشنهاد کارشناس» که به طور
                            اختصاصی برای شما تدوین شده با دقت عمل کنین تا نتیجه چشمگیری بگیرید.
                        </div>
                    </div>
                    <div class="questionBox">
                        <div class="question boldFont">
                        ...
                        <div class="answer lightFont organizer">
                            از اون جایی که با رژیم های از شنبه به مرور و در طول زمان وزن خودتون رو کم می کنین دچار
                            بازگشت وزن نمی شید. افراد با رژیم های سخت در همان ابتدا وزن زیادی رو از دست میدن اما از
                            اونجایی که نمیتونن طولانی مدت از این رژیم پیروی کنن، مجددا دچار اضافه وزن میشن. هدف از شنبه
                            کاهش وزنتون بر اساس تغییر سبک زندگیه. پس کاهش وزن رو فقط به عنوان هدف کوتاه مدت نبینین و
                            خودتون رو برای یک موفقیت طولانی مدت آماده کنین.
                        </div>
                    </div>
                    <div class="questionBox">
                        <div class="question boldFont">
                        ...
                        <div class="answer lightFont organizer">
                            رژیم های سخت عوارضی مثل ریزش مو، شکنندگی ناخن ها، مشکلات پوستی، بروز سنگ های صفراوی، پوکی
                            استخوان، افسردگی، تضعیف سیستم ایمنی بدن و... را به دنبال دارن. از شنبه افتخار میکنه که رژیم
                            هایی که طراحی کرده هیچ عوارض جانبی ای در پی نداشته و هیچ گزارشی از رژیم گیرنده ها در این
                            رابطه ثبت نشده.
                        </div>
                    </div>
                    <div class="questionBox">
                        ...
                        <div class="answer lightFont organizer">
                            رژیم های از شنبه با مواد غذایی ای طراحی می شود که در دسترس همه وجود دارن. هماهنگی این رژیم
                            ها با سفره غذایی خانواده باعث میشه تنها کمی محدودیت وجود داشته باشه و محرومیتی برای افراد
                            ایجاد نشه. نکته دیگه اینه که فردی که می خواد وعده های غذایی رو آماده کنه بخاطر مشابهت غذای
                            رژیم با غذای خانواده به زحمت اضافه نمیفته، پس همه چیز برای انجام یک رژیم خوب و بی دردسر
                            مهیاست.
                        </div>
                    </div>
                    <div class="questionBox">
                        ...
                        <div class="answer lightFont organizer">
                            تیم پشتیبانی از شنبه تمام وقت آماده ارائه مشاوره و پاسخگویی به سوال های شماست. هر سوالی
                            ذهنتون رو مشغول کرد کافیه به واتساپ شماره 09981150317 پیام بدید یا با شماره 23051172-021
                            تماس بگیرین. پشتیبان ها با روی باز از شما استقبال میکنن.
                        </div>
                    </div>
                    <div class="questionBox">
                        <div class="question boldFont">
                        ...
                        <div class="answer lightFont organizer">
                            اگه دارای بیماری یا مشکل جسمی خاص هستین، مطمئن باشین که رژیم شما با مشورت تیم تخصصی پزشکی و
                            بر اساس اطلاعات شما طراحی میشه. هیچ چیز نمیتونه مانع رسیدن شما به وزن ایدئالتون بشه.
                        </div>
                    </div>
                    <div class="questionBox">
                        <div class="question boldFont">
                        ...
                        <div class="answer lightFont organizer">
                            از شنبه به خودش می باله که تونسته رضایت رژیم گیرنده ها رو جلب کنه. پیام های کسب نتیجه مطلوب
                            و قدردانی از تیم متخصصان لبخند رو به لب تیم از شنبه میاره و اونها رو به تلاش بیشتر دلگرم
                            میکنه.
                        </div>
                    </div>
                    <div class="questionBox">
                        ...
                        <div class="answer lightFont organizer">
                            شما با پرداخت هزینه ای مناسب و برخورداری از پشتیبانی کامل و همه جانبه می تونین یک رژیم غذایی
                            کامل و بی نقص داشته باشین و لحظه به لحظه بیشتر به رویای تناسب اندام تون نزدیک بشین.
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-center align-content-center flex-wrap w-100">
                <div class="textInCenter position-relative d-flex flex-wrap mt-4">
                    <div class="d-flex w-100 align-items-center justify-content-center boxslider">
                        ...
                        <a href="tel:+989352230154" class="mb-0 d-flex align-items-center a-tel-support"
                           title="۰۹۳۵۲۲۳۰۱۵۴">
                            ۰۹۳۵۲۲۳۰۱۵۴
                        </a>
                    </div>
                ...
                <div class="instagramFollow textInCenter textInCenter d-flex flex-wrap position-relative mt-4">
                    <h2 class="boldFont font-size-16 w-100 custom-font-gray">ما را در اینستاگرام دنبال کنید</h2>
                    <a class="instagramButton font-size-18 whiteColor cursor-pointer"
                       href="http://instagram.com/azshanbe.me/" title="azshanbe.me">
            ...
            <div class="normalHeader relative organizer">
                ...
                <p class="redColor" style="text-align:center; margin: 30px 0 0 0;">برای دیدن آموزش ثبت نام ویدیو را
                    ببینید.</p>
            </div>
            <div class="smallSizeHandler">
                ...
                max-height: 553px;
            "
                            src="https://www.aparat.com/video/video/embed/videohash/r6a4Q/vt/frame"
            ...
            <div class="desktopShadowSeparator" id="videobox">
                ...
                <div class="normalHeader relative organizer" style="margin: 0 !important;">
                    ...
                    <p class="redColor" style="text-align:center; margin: 30px 0;">با ما به وزن ایده‌آل‌تون برسید و
                        جایزه
                        بگیرید :)</p>
                </div>
                    ...
                    <div class="items pos-relative">
                        <div class="itemBox">
                            <div class="itemImage progressive">
                                <img class="progressive__img progressive--is-loaded" data-progressive="img/tablet.png"
                                     src="img/tablet.png">
                            </div>
                        ...
                        <div class="itemBox">
                            <div class="itemImage progressive">
                                <img class="progressive__img progressive--is-loaded" data-progressive="img/money.png"
                                     src="img/money.png">
                            </div>
                        ...
                        <div class="itemBox">
                            <div class="itemImage progressive">
                                <img class="progressive__img progressive--is-loaded" data-progressive="img/mobile.png"
                                     src="img/mobile.png">
                            </div>
                        ...
                        <div class="itemBox">
                            <div class="itemImage progressive">
                                <img class="progressive__img progressive--is-loaded"
                                     data-progressive="img/diet-plan.png" src="img/diet-plan.png">
                            </div>
                            <h2 class="font-size-16">یک دوره رژیم رایگان</h2>
                        </div>
                    </div>
                    <div class="redItem desktopVersion progressive">
                        <img class="progressive__img progressive--is-loaded" data-progressive="img/bottomPinkShape.svg"
                             src="img/bottomPinkShape.svg">
                    </div>
                </div>
                    ...
                    <div class="footer-section d-flex flex-wrap">
                        ...
                        <div class="d-flex flex-wrap align-content-start px-3 w-32">
                            ...
                            <ul class="d-flex flex-wrap">
                                <li class="w-100 d-flex align-items-center mb-3"><a href="https://azshanbe.me/about"
                                                                                    title="درباره ما">درباره ما</a></li>
                                <li class="w-100 d-flex align-items-center mb-3"><a href="https://azshanbe.me/contact"
                                                                                    title="تماس با ما">تماس با ما</a>
                                </li>
                                <li class="w-100 d-flex align-items-center mb-3"><a
                                        href="https://azshanbe.me/#change_users_style" title="تغییرات مراجعین">تغییرات
                                        مراجعین</a></li>
                                <li class="w-100 d-flex align-items-center mb-3"><a href="https://azshanbe.me/mag/"
                                                                                    title="مطالب آموزشی">مطالب
                                        آموزشی</a></li>
                                <li class="w-100 d-flex align-items-center mb-3"><a href="https://azshanbe.me/terms"
                                                                                    title="قوانین و مقررات">قوانین و
                                        مقررات</a></li>
                            </ul>
                        </div>
                        <div class="d-flex flex-wrap align-content-start px-3 mb-5 w-32">
                            ...
                            <ul class="d-flex flex-wrap">
                                ...
                                {{--                            </li>--}}
                                <li class="d-flex align-items-center mb-3 w-100">
                                    <svg version="1.1" id="Capa_1" class="w-25px ml-3"
                                ...
                                <li class="d-flex align-items-center mb-3 w-100">
                                    <ul class="d-flex align-items-center flex-wrap social-footer justify-content-center">
                                        <li class=" ml-3"><a href="http://instagram.com/azshanbe.me/"
                                                             class="instagram-footer d-flex align-items-center justify-content-center"
                                                             title="اینستاگرام ازشنبه"><i
                                                    class="icon icon-instagram"></i></a></li>
                                        <li>
                                            <a href="https://wa.me/+989352230154"
                                               class="whatsapp-footer d-flex align-items-center justify-content-center"
                                               title="ارتباط با پشتیبان">
                                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" x="15px" y="15px"
                                                     viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;"
                                                     xml:space="preserve">
                                    ...
                                    <ul>
                                        <li>
                                            <a referrerpolicy="origin" target="_blank"
                                               href="https://trustseal.enamad.ir/?id=294206&amp;Code=GIcy97w9VwjjC4J5tWgI"><img
                                                    referrerpolicy="origin"
                                                    src="https://Trustseal.eNamad.ir/logo.aspx?id=294206&amp;Code=GIcy97w9VwjjC4J5tWgI"
                                                    alt="" style="cursor:pointer" id="GIcy97w9VwjjC4J5tWgI"></a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
    ...
    <div class="pos-fixed justify-content-center flex-wrap bg-white mm-menu">
        ...
        <ul class="w-100 d-flex flex-wrap mm-menu-items px-5 my-3">
            ...
            <li class="pos-relative w-100 d-flex align-items-center pr-4">
                <a href="https://azshanbe.me/terms" class="custom-font-gray" title="قوانین و مقررات"> قوانین و
                    مقررات </a>
            </li>
            <li class="pos-relative w-100 d-flex align-items-center pr-4">
        ...
        <footer>
        <span class="d-flex align-items-center justify-content-center close-btn-mm-menu cursor-pointer close-modal"
              data-target=".mm-menu">
            بستن
        </span>
        </footer>
    ...
    <a href="https://wa.me/+989352230154" target="_blank" class="custom-support-btn" title="ارتباط با پشتیبان">
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             x="30px" y="30px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
        <path style="fill:#FAFAFA;" d="M256.064,0h-0.128l0,0C114.784,0,0,114.816,0,256c0,56,18.048,107.904,48.736,150.048l-31.904,95.104
				l98.4-31.456C155.712,496.512,204,512,256.064,512C397.216,512,512,397.152,512,256S397.216,0,256.064,0z"></path>
            <path style="fill:#4CAF50;" d="M405.024,361.504c-6.176,17.44-30.688,31.904-50.24,36.128c-13.376,2.848-30.848,5.12-89.664-19.264
				C189.888,347.2,141.44,270.752,137.664,265.792c-3.616-4.96-30.4-40.48-30.4-77.216s18.656-54.624,26.176-62.304
