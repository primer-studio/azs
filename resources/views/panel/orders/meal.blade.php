<div
    class="meal meal-{{ $day }} {{ $meal }} {{ $meal }}-{{ $day }} border border-dark kt-portlet  kt-portlet--height-fluid"
    data-meal="{{ $meal }}" data-day="{{ $day }}">
    <div class="kt-portlet__head kt-portlet__head--noborder">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                {{ $title }} <small>(@lang('general.day') {{ $day }})</small>
            </h3>
        </div>
    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="search-main form-group">
                            <div class="kt-input-icon kt-input-icon--left">
                                <input type="text" class="search-food search-input form-control"
                                       data-day="{{ $day }}" data-type="food" data-meal="{{ $meal }}" placeholder="Search...">
