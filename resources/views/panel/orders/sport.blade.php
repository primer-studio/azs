<div
    class="sport sport-{{ $day }} border border-dark kt-portlet  kt-portlet--height-fluid" data-day="{{ $day }}">
    <div class="kt-portlet__head kt-portlet__head--noborder">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                @lang('general.sport') <small>(@lang('general.day') {{ $day }})</small>
            </h3>
        </div>
    </div>
    <div class="kt-portlet__body pt-1 pb-2 px-3">
        <!--begin::sports list-->
        <div class="sports-list"></div>
        <!--end::sports list-->
        <!--begin::search-->
                    ...
                    <div class="col-lg-4">
                        <div class="search-main form-group">
                            <div class="kt-input-icon kt-input-icon--left">
                                <input type="text" class="search-sport search-input form-control"
                                       data-day="{{ $day }}"  data-type="sport"  placeholder="Search...">
