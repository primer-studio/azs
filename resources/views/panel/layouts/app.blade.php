...
<head>
    ...
    <link href="{{ asset('panel-assets/template/assets/plugins/global/plugins.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('panel-assets/template/assets/css/style.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />

    <!--end::Global Theme Styles -->

    <!--begin::Layout Skins(used by all pages) -->
    <link href="{{ asset('panel-assets/template/assets/css/skins/header/base/light.rtl.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('panel-assets/template/assets/css/skins/header/menu/light.rtl.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('panel-assets/template/assets/css/skins/brand/dark.rtl.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('panel-assets/template/assets/css/skins/aside/dark.rtl.css')}}" rel="stylesheet" type="text/css" />

    <!--end::Layout Skins -->
    <link rel="shortcut icon" href="{{ asset('panel-assets/template/assets/media/logos/favicon.ico')}}" />

    <!--begin::general styles -->
    <link href="{{ asset('panel-assets/css/styles.css?v=1.01')}}" rel="stylesheet" type="text/css" />
    <!--end::general styles  -->
    @stack('styles')
</head>
...
<!-- begin::Body -->
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading @if(isset($minimize_sidebar)) kt-aside--minimize @endif">
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="index.html">
            <img alt="Logo" src="{{ asset('panel-assets/template/assets/media/logos/logo-light.png')}}" />
        </a>
    </div>
...
-->
            ...
            -->
                                        ...
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ asset('panel-assets/template/assets/media/products/product9.jpg')}}" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ asset('panel-assets/template/assets/media/products/product13.jpg')}}" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ asset('panel-assets/template/assets/media/products/product16.jpg')}}" title="">
                                                </a>
                                            </div>
                                        </div>
                                        <div class="kt-mycart__item">
                                            <div class="kt-mycart__container">
                                                ...
                                                <a href="#" class="kt-mycart__pic">
                                                    <img src="{{ asset('panel-assets/template/assets/media/products/product15.jpg')}}" title="" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--langs">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon">
										<img class="" src="{{ asset('panel-assets/template/assets/media/flags/226-united-states.svg')}}" alt="" />
									</span>
                        </div>
                            ...
                            <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                <li class="kt-nav__item kt-nav__item--active">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="{{ asset('panel-assets/template/assets/media/flags/226-united-states.svg')}}" alt="" /></span>
                                        <span class="kt-nav__link-text">English</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="{{ asset('panel-assets/template/assets/media/flags/128-spain.svg')}}" alt="" /></span>
                                        <span class="kt-nav__link-text">Spanish</span>
                                    </a>
                                </li>
                                <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link">
                                        <span class="kt-nav__link-icon"><img src="{{ asset('panel-assets/template/assets/media/flags/162-germany.svg')}}" alt="" /></span>
                    ...
                    <div class="kt-header__topbar-item kt-header__topbar-item--user">
                        <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                            <div class="kt-header__topbar-user">
                                ...
                                <img class="kt-hidden" alt="Pic" src="{{ asset('panel-assets/template/assets/media/users/300_25.jpg')}}" />
    ...
    <div class="kt-demo-panel__body">
        <div class="kt-demo-panel__item kt-demo-panel__item--active">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo1.jpg')}}" alt="" />
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo2.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo3.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo4.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo5.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo6.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo7.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo8.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo9.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo10.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo11.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo12.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo13.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo14.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo15.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo16.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo17.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo18.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo19.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo20.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo21.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo22.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo23.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo24.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo25.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo26.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo27.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo28.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo29.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
        ...
        <div class="kt-demo-panel__item ">
            ...
            <div class="kt-demo-panel__item-preview">
                <img src="{{ asset('panel-assets/template/assets/media//demos/preview/demo30.jpg')}}" alt="" />
                <div class="kt-demo-panel__item-preview-overlay">
                    <a href="#" class="btn btn-brand btn-elevate disabled">Coming soon</a>
                </div>
            </div>
                            ...
                            <div class="kt-chat__messages kt-chat__messages--solid">
                                <div class="kt-chat__message kt-chat__message--success">
                                    <div class="kt-chat__user">
												<span class="kt-media kt-media--circle kt-media--sm">
													<img src="{{ asset('panel-assets/template/assets/media/users/100_12.jpg')}}" alt="image">
												</span>
                                ...
                                <div class="kt-chat__message kt-chat__message--right kt-chat__message--brand">
                                    <div class="kt-chat__user">
                                        ...
                                        <span class="kt-media kt-media--circle kt-media--sm">
													<img src="{{ asset('panel-assets/template/assets/media/users/300_21.jpg')}}" alt="image">
												</span>
                                    </div>
                                    <div class="kt-chat__text">
...
<!--begin:: functionality javascript files -->
<script src="{{ asset('/panel-assets/js/xss.js') }}"></script>
<script src="{{ asset('/js/functions.js') }}"></script>
<script src="{{ asset('/panel-assets/js/functions.js?v=1.01') }}"></script>

@stack('script_variables')
@stack('scripts')
<!--end:: functionality javascript files -->

<!--begin::Page Scripts(used by this page) -->
<script src="{{ asset('panel-assets/template/assets/js/pages/dashboard.js')}}" type="text/javascript"></script>
<!--end::Page Scripts -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            @foreach ($errors->all() as $error)
                var error = '{!! str_replace("'", "\'",  $error) !!}';
                var toastr_instance = toastr;
                toastr_instance.options.timeOut = 0;
                toastr_instance.options.extendedTimeOut = 0;
                toastr_instance.error(error);
            @endforeach
        })
    </script>
@endif
...
{{--begin::errors in session flashError() (by redirect back)--}}
@if (Session::has('flash_errors'))
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            @foreach (Session::pull('flash_errors') as $error)
                var error = '{!! $error !!}';
                var toastr_instance = toastr;
                toastr_instance.options.timeOut = 0;
                toastr_instance.options.extendedTimeOut = 0;
...
@endif
{{--end::errors in session flashError() (by redirect back)--}}

{{--  sohe success_message  --}}
@if (\Session::has('success'))
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            var success = '{!! \Session::get('success') !!}';
            var toastr_instance = toastr;
            toastr_instance.options.timeOut = 10000; // How long the toast will display without user interaction
            toastr_instance.options.extendedTimeOut = 0; // How long the toast will display after a user hovers over it
            toastr_instance.options.progressBar = true;
            toastr_instance.success(success);
        })
    </script>
@endif
{{--  sohe success_message  --}}
