<div class="kt-portlet">
    <div class="kt-portlet__body">
        ...
        <form action="{{ isset($role) ? route('panel.roles.update', ['role' => $role->id]) : route('panel.roles.store') }}"
            ...
            <div class="mt-4 mb-3">
                <div class="row">
                    @forelse(\Spatie\Permission\Models\Permission::where('guard_name', 'web')->get() as $permission)
                        <div class="col-lg-2">
