...
return [
    ...
    */
    ...
    'custom' => [
        'short_name.regex' => 'نام انگلیسی تنها می تواند شامل حروف کوچک انگلیسی  به همراه "_" باشد',
        'parent_question_id_self' => 'سوال نمیتواند زیر مجموعه خودش باشد',
        'wrong_mobile_format' => 'فرمت شماره موبایل اشتباه است',
        'wrong_username_format' => ':attribute تنها می تواند شامل حروف انگلیسی و اعداد به همراه "_" باشد',
        'verified_transaction_can_not_be_changed' => 'شما نمیتوانید تراکشنی که وضعیت "پرداخت موفق" دارد را تغییر دهید',
        'strong_password' => ':attribute باید :minLength - :maxLength کاراکتر باشد و شامل اعداد و نشانه ها و حروف بزرگ و کوچک انگلیسی باشد'
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'province'              => 'استان',
        // azshanbe
        'duration_in_day'       => 'تعداد روزهای رژیم',
        'diet_id'               => 'رژیم',
        'step_id'               => 'مرحله',
        'period'                => 'دوره',
        'short_name'            => 'نام کوتاه انگلیسی',
        'status'                => 'وضعیت',
        'price'                 => 'قیمت',
        'sort'                  => 'ترتیب',
        'parent_question'       => 'سوال پدر',
        'available_if_parent_answer_operator'       => 'شرط نمایش سوال',
        'available_if_parent_answer_value'          => 'مقدار شرط سوال پدر',
        'answer_properties' => [
            'type' => 'نوع پاسخ',
        ],
        'amount' => "مبلغ",
        ...
        'unit' => 'واحد',
        'calories_per_unit' => 'کالری هر واحد',
        'date_of_birth' => 'تاریخ تولد',
        'height' => 'قد',
        'marital_status' => 'وضعیت تاهل',
        'last_diet' => 'آخرین رژیم',
        'blood_type' => 'گروه خونی',
        'illness_history' => 'سابقه بیماری',
        'favorite_foods' => 'غذاهای مورد علاقه',
        'disgusting_foods' => 'غذاهای مورد تنفر',
        'prohibited_foods' => 'غذاهای منع شده',
        'commission_rate' => 'درصد کمیسیون',
        'step' => 'مرحله',
        'is_temp' => 'کاربر موقت',
        'is_dissatisfied' => 'ناراضی',
